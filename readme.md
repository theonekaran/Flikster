...
Flikster is a movies app using the [The Movie Database API](http://docs.themoviedb.apiary.io/#).
...
- [x] User can see the release date in the details
- [x] User can see the rating in the details
